...
impl LookupResult {
    ...
    pub fn is_asn_allowed(
        ...
        // 2. Provider organization substring match (e.g. "Proton AG", "M247", "Dataclub")
        ...
        // 3. Unrestricted mode (if no explicit ASNs or providers are specified)
        if allowed_asns.is_empty() && allowed_providers.is_empty() {
            return true;
        }

        // 4. If explicit ASNs are empty, allow any valid public IP
