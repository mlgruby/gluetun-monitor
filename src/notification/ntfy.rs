...
pub async fn send_notification(
    ...
    let message = build_message(info, allowed_asns, allowed_providers, home_ip, change_details);
    let title = determine_title(info, allowed_asns, allowed_providers, home_ip, change_details);
    let priority = determine_priority(info, allowed_asns, allowed_providers, home_ip, change_details);
